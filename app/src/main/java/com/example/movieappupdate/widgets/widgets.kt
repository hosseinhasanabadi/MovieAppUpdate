package com.example.movieappupdate.widgets
    ...
    Card(
        ...
        Row(
            ...
            Surface(
                modifier = Modifier
                    .padding(12.dp)
                    .size(100.dp), shape = RectangleShape, shadowElevation = 4.dp
            ) {
            ...
            Column(modifier = Modifier.padding(4.dp)) {
                ...
                AnimatedVisibility(visible = expanded) {
                    Column() {
                        ...
                        Text(text = "Rating: ${movie.actors}",style = MaterialTheme.typography.bodySmall)
                        //Text(text = "Actors: ${movie.actors}",style = MaterialTheme.typography.bodySmall)
